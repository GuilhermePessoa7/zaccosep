...
$sql ="INSERT INTO laudos (numerocliente, numerolaudo, descricao, datalaudo, validade, datavalidade, arquivo) VALUES(:numerocliente, :numerolaudo, :descricao, :datalaudo, :validade, :datavalidade, :arquivo )";
...
<div class="row">
    ...
    <div class="card-body">             
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title"><i class="fas fa-user"></i> &nbsp; Cadastrar Laudos</h4>
