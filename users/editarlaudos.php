...
$sql="UPDATE laudos SET numerocliente=(:numerocliente), numerolaudo=(:numerolaudo), descricao=(:descricao), datalaudo=(:datalaudo), validade=(:validade), datavalidade=(:datavalidade), arquivo=(:arquivo) WHERE id=(:idedit)";
...
<div class="row">
    ...
    <div class="card-body">             
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title"><i class="fas fa-user"></i> &nbsp;  Editar o laudo Nº <?php echo htmlentities($result->numerolaudo); ?> </h4>
                                                    ...
                                                    <form class="form-material m-t-40 row" method="post" enctype="multipart/form-data">
		                                                ...
		                                                <input type="hidden" name="idedit" value="<?php echo htmlentities($result->id);?>" >
                                                            <span class="help-block text-muted"><small>Caso deseja upar novo arquivo, somente escolher o novo.</small></span>
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-3 m-t-20">
                                                            <input type="text" name="datalaudo" id="dataInicio" data-date-format="dd/mm/yyyy" class="form-control" value="<?php echo htmlentities($result->datalaudo);?>" required>
