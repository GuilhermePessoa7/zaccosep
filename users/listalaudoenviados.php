                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Lista de Laudos Enviados</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover" id="tabela">
                                            <thead>
                                                ...
                                                <th style='text-align: center; width: 50%; white-space: nowrap;'><i class='fas fa-envelope'></i> <br>&nbsp; Email que foi enviado</th>
                                                ...
                                                <th style='text-align: center; white-space: nowrap;'><i class='far fa-calendar-alt'></i><br>&nbsp; Data & Hora do Envio</th>
                                                </tr>
                                            </thead>
                                            <tbody>

<?php $sql = "SELECT * from  laudos_enviados ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
                                                ...
                                                <tr>
                                                <td style="text-align: center;"><a style="color: red; font-weight: bold"><?php echo htmlentities($result->numerocliente);?></a></td>
                                                    <td style="text-align: center;"><a style="color: red; font-weight: bold"><?php echo htmlentities($result->numerolaudo);?></a></td>
                                                    ...
                                                    <td style='text-align: center;'><a style="color: red; font-weight: bold"><?php echo date('d/m/Y H:i:s', strtotime($result->DataDoEnvio)) ?></a></td>
                                                </tr>
