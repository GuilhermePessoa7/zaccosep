...
$query->execute();
	...
	$Assunto  = "Seu laudo está preste a vencer";
    $Conteudo = "
			<p style='line-height: 150%; color: #000; font-weight: 700; font-size: 16px'>
            Somos da empresa SEP - Ensaios Elétricos e viemos através desse email informar que o seu laudo do número <a style='color: red'>".$numerolaudo."</a> vence no dia <a style='color: red'>".date("d/m/Y", strtotime($datavalidade))."</a> porfavor ficar ciente deste aviso!
			</p>
...
";
    ...
    $msg="Notificação enviado com sucesso!";
    echo "<script type='text/javascript'> setTimeout(function() { window.location.href = 'laudosavencer.php';}, 1000); </script>";
}   
