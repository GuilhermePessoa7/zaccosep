...
$query->execute();
 ...
 $cc = $email;
    ...
    $Conteudo = "
            ...
            Somos da empresa SEP - Ensaios Elétricos e viemos através desse email informar que o seu laudo do número <a style='color: red'>".$numerolaudo."</a> venceu no dia <a style='color: red'>".date("d/m/Y", strtotime($datavalidade))."</a> porfavor ficar ciente deste aviso!
			</p>
