...
$sql="UPDATE clientes SET nomempresa=(:nomempresa), cnpj=(:cnpj), responsavel=(:responsavel), email=(:email), telefone=(:telefone), matriculacliente=(:matriculacliente) WHERE id=(:idedit)";
