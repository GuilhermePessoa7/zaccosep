...
$sql ="INSERT INTO clientes (nomempresa, cnpj, responsavel, email, telefone, matriculacliente) VALUES(:nomempresa, :cnpj, :responsavel, :email, :telefone, :matriculacliente)";
