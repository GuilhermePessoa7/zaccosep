...
{				?>	
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center; width: 10%;"><input type="date" id="datavalidade" value="<?php echo htmlentities($result->datalaudo);?>" disabled></td>
                                                    <td style="text-align: center;"><?php echo htmlentities($result->validade);?></td>
                                                    <td style="text-align: center; width: 10%;"><input type="date" id="datavalidade" value="<?php echo htmlentities($result->datavalidade);?>" disabled></td>
                                                    <td style="text-align: center;">
                                                    <center><a href="editarlaudos.php?edit=<?php echo $result->id;?>"><button class="btn btn-blue waves-effect waves-light"><span class="btn-label"><i class="far fa-edit"></i></span> Editar</button></a>
                                                            <a href="./../laudos<?php echo $result->arquivo;?>" target="_blank"><button class="btn btn-blue waves-effect waves-light" style="color: #fff;"><span class="btn-label"><i class="fas fa-eye"></i></span> Visualisar</button></a>
                                                    </center>
