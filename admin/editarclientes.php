...
$sql="UPDATE clientes SET nomempresa=(:nomempresa), cnpj=(:cnpj), responsavel=(:responsavel), email=(:email), telefone=(:telefone), celular=(:celular), matriculacliente=(:matriculacliente) WHERE id=(:idedit)";
...
<div class="row">
    ...
    <div class="card-body">             
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title"><i class="fas fa-user"></i> &nbsp;  Editar o cliente Nº <?php echo htmlentities($result->nomempresa); ?> </h4>
                                                    ...
                                                    <div class="form-group col-md-2 m-t-20">
                                                            <input type="tel" name="matriculacliente" onkeypress="return somenteNumeros(event)" class="form-control" value="<?php echo htmlentities($result->matriculacliente); ?>"> 
                                                            <span class="help-block text-muted"><small>Digite aqui a matricula do cliente</small></span>
                                                        </div>
                                                        <div class="form-group col-md-4 m-t-20">
                                                            <input type="text" name="nomempresa" class="form-control form-control-line" value="<?php echo htmlentities($result->nomempresa); ?>">
                                                            <span class="help-block text-muted"><small>Digite aqui o nome da empresa do cliente</small></span> 
                                                        </div>
                                                        <div class="form-group col-md-3 m-t-20">
                                                            <input type="tel" name="cnpj" attrname="cnpj" class="form-control" value="<?php echo htmlentities($result->cnpj); ?>"> 
                                                            <span class="help-block text-muted"><small>Digite aqui o CNPJ do cliente</small></span>
                                                        </div>
                                                        <div class="form-group col-md-3 m-t-20">
                                                            <input type="text" name="responsavel" class="form-control" value="<?php echo htmlentities($result->responsavel); ?>"> 
                                                        ...
                                                        <div class="form-group col-md-4 m-t-20">
                                                            <input type="tel" name="telefone" attrname="telefone" class="form-control" value="<?php echo htmlentities($result->telefone); ?>"> 
                                                            <span class="help-block text-muted"><small>Digite aqui o telefone do cliente</small></span>
                                                        </div>
                                                        <div class="form-group col-md-4 m-t-20">
                                                            <input type="tel" name="celular" attrname="celular" class="form-control" value="<?php echo htmlentities($result->celular); ?>" required> 
