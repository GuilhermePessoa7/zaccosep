...
$sql="UPDATE laudos SET numerocliente=(:numerocliente), numerolaudo=(:numerolaudo), descricao=(:descricao), datalaudo=(:datalaudo), validade=(:validade), datavalidade=(:datavalidade), arquivo=(:arquivo), email=(:email) WHERE id=(:idedit)";
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <form class="form-material m-t-40 row" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <input type="file" name="arquivo" value="<?php echo htmlentities($result->arquivo);?>" class="form-control">
