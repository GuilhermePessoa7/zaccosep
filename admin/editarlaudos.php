...
$sql="UPDATE laudos SET numerocliente=(:numerocliente), numerolaudo=(:numerolaudo), descricao=(:descricao), datalaudo=(:datalaudo), validade=(:validade), datavalidade=(:datavalidade), email=(:email) WHERE id=(:idedit)";
