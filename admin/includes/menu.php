            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-users" aria-hidden="true"></i><span class="hide-menu">Fúncionarios</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="adicionarfuncionarios.php">Adicionar Fúncionarios<i class="fas fa-user-plus"></i></a></li>
                                <li><a href="listafuncionarios.php">Lista de Fúncionarios<i class="fas fa-list"></i></a></li>
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-search"></i><span class="hide-menu">Consultar Laudos</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="buscar.php">Buscar por Núm. do Cliente<i class="fas fa-user"></i></a></li>
                                <li><a href="buscar.php">Buscar por Núm. do Laudo <i class="far fa-file"></i></a></li>
                                <li><a href="buscar.php">Buscar por Descrição <i class="fas fa-align-center"></i></a></li>
                                <li><a href="buscar.php">Buscar por Data<i class="far fa-calendar-alt"></i></a></li>
                            </ul>
                        </li>
