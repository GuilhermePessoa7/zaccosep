                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card text-white" style="background: #1F1E69;">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white" style="text-align: center;"><i class="fa fa-users" aria-hidden="true"></i> &nbsp; Funcionários Cadastrados </h4></div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card text-white bg-success">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white" style="text-align: center;"><i class="far fa-file"></i>&nbsp; Laudos Cadastrados </h4></div>
                                <div class="card-body">
                                    <p class="card-text" style="text-align: center;">Hoje no nosso sistema temos exatamente</p>
                        ...
                        <div class="col-md-4">
                            <div class="card text-white" style="background: #f87563;">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white" style="text-align: center;"><i class="fas fa-user"></i>&nbsp; Clientes Cadastrados </h4></div>
                                <div class="card-body">
                                    <p class="card-text" style="text-align: center;">Hoje no nosso sistema temos exatamente</p>
