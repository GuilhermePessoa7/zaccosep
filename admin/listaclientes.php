        ...
        <?php include('includes/logoutmodal.php');?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered m-t-30 table-hover contact-list" id="myTable" data-paging="true" data-paging-size="7">
                                            <thead>
                                                <tr>
                                                    <th style="text-align: center;"><i class="fas fa-bell"></i>&nbsp; Matrícula</th>
                                                    <th style="text-align: center;"><i class="fas fa-hospital-alt"></i> &nbsp; Nome da empresa</th>
                                                    <th style="text-align: center;"><i class="fas fa-info-circle"></i> &nbsp; CNPJ</th>
                                                    <th style="text-align: center;"><i class="fas fa-user"></i>&nbsp; Responsável</th>
                                                    <th style="text-align: center;"><i class="fas fa-comment-alt"></i>&nbsp; Email</th>
                                                    <th style="text-align: center;"><i class="fas fa-phone"></i>&nbsp; Telefone</th>
...
{				?>	
                                                ...
                                                <td style="text-align: center;"><?php echo htmlentities($result->matriculacliente);?></td>
                                                    ...
                                                    <center><a href="editarclientes.php?edit=<?php echo $result->id;?>"><button class="btn btn-blue waves-effect waves-light"><span class="btn-label"><i class="far fa-edit"></i> Editar</span></button></a>
                                                            <a><button data-toggle="modal" data-target="#excluir-funcionarios" class="btn btn-red waves-effect waves-light" style="color: #fff;"><span class="btn-label"><i class="fas fa-trash"></i> Excluir</span></button></a>
                                                    </center>
