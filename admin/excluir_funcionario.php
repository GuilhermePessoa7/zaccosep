...
if(isset($_GET['edit']))
  ...
  if(isset($_POST['submit']))
    ...
    $sql = "delete from users WHERE id=(:idedit)";
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Excluir Funcionario</li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<div class="row">
    ...
    <div class="card-body">             
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title"><i class="fas fa-user"></i> &nbsp; Exclua o funcionario <?php echo htmlentities($result->name); ?></h4>
                                                    <h6 class="card-subtitle"><code><i class="fas fa-angle-double-right"></i> Exclua o funcionario <?php echo htmlentities($result->name); ?> do sistema</code></h6>
                                                    <form class="form-material m-t-40 row" method="post" enctype="multipart/form-data" name="regform" onSubmit="return validate();">
                                                        <div class="form-group col-md-6 m-t-20">
                                                            <input type="text" name="name" class="form-control form-control-line"  value="<?php echo htmlentities($result->name);?>" disabled>
                                                            <span class="help-block text-muted"><small>Digite aqui o nome do funcionario que deseja editar ao sistema.</small></span> 
                                                        </div>
                                                        <div class="form-group col-md-6 m-t-20">
                                                            <input type="email" name="email" class="form-control form-control-line" value="<?php echo htmlentities($result->email);?>" disabled>
                                                            <span class="help-block text-muted"><small>Digite aqui a email do funcionario que deseja editar ao sistema.</small></span>
                                                        </div>
                                                        <div class="form-group col-md-6 m-t-20">
                                                            <input class="form-control" type="text" name="mobileno" attrname="telefone" value="<?php echo htmlentities($result->mobile);?>" disabled>
                                                         ...
                                                         <select name="gender" class="form-control" disabled>
                                                                    <option value="<?php echo htmlentities($result->gender);?>" disabled><?php echo htmlentities($result->gender);?></option>
